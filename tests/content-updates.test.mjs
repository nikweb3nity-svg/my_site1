...
assert.equal((html.match(/mailto:nik\.wen3nity@gmail\.com/g) ?? []).length, 2);
assert.equal((html.match(/https:\/\/t\.me\/web82_studio/g) ?? []).length, 2);
assert.doesNotMatch(html, /hello@signal\.studio/);
